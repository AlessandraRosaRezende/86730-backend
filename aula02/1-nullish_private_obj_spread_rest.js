...
// // 0 = false 1 = true
// const variavelPreenchida = taxaContrato || 0.5;
...
//     return this.#idade;
//   }
//   getIdade = () => this.#calculaIdade(); // return implícito
// }
...
const key = 'nome'
// console.log(educador[key]) // console.log(educador['nome'])

// console.log(educador.nome, educador.idade, educador.tamanho);
...
const mascararCPF = (cpf) => {
  return cpf.replace(/(\d{3})\.(\d{3})\.(\d{3})-(\d{2})/, '***.***.***-**'); //regex
};
